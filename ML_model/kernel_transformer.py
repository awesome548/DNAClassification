import math
from ML_model.mha_block import MHA_block, MHA_block_rezero
from ML_model.utils import Positional_embeddings
import torch
...
class Kernel_transformer(nn.Module):
    ...
    def __init__(self, use_cos, kernel, d_model, n_heads, n_layers,
        ...
        Args:
          use_cos: (bool) If True, the cosine reweighting mechanism is implemented and positional
            embeddings are not used. If False, sinusoidal positional embeddings are used.
